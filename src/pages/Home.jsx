          ...
          <div className="max-w-3xl mx-auto contenedorCosas opacity-0 animate-fade-in-up" style={{ animationDelay: "0.3s" }}>
            <Card>
              <div className="space-y-3">
                ...
                {/* Error */}
                {error && (
                  <div className="flex items-start gap-3 p-4 bg-red-50 border border-red-100 rounded-lg opacity-0 animate-fade-in" style={{ animationDelay: "0.1s" }}>
                ...
                {/* Resultado */}
                {affiliateUrl && (
                  <div className="space-y-4 pt-4 opacity-0 animate-fade-in-up" style={{ animationDelay: "0.2s" }}>
